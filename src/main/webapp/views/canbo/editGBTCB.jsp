...
<body>
	...
	<div class="container khaisinh">
		...
		<div class="khaisinh__content">
			...
			<s:form class="form-body" action="addGBTCB" commandName="gbt"
				modelAttribute="gbt">

				<div class="col-md-6">
					<p>ID:</p>
					<div class="form-group">
						<input type="text" class="form-control" name="id_gbt"
							value="${list.id_gbt}" readonly="readonly" />
					</div>
				</div>
				...
				<div class="col-md-12">
					Lí Do:<input type="text" name="lyDo"
						value="${list.lyDo}" class="w-100 form-control">
					</p>
				</div>
				<div class="col-md-6">
					<p>
						Tên người làm giấy<input name="tenNguoiLamGiay" type="text"
							value="${list.tenNguoiLamGiay}" class="w-100 form-control">
					</p>
				</div>
				<div class="col-md-6">
					<p>
						Ghi chú:<input name="note" type="text"
							value="${list.note}" class="w-100 form-control">
					</p>
				</div>
					<div class="col-md-6">
					<p>
						Nơi mất:<input name="noiMat" type="text"
							value="${list.noiMat}" class="w-100 form-control">
					</p>
				</div>
					...
					<div class="col-md-6">
					<p>
						Ngày mấtt:<input name="ngayMat" type="date"
							value="${list.ngayMat}" class="w-100 form-control">
					</p>
				</div>
				...
				<%-- 	<p>
						Tuổi:<input name="tuoi" type="text"
							value="${list.tuoi}" class="w-100 form-control">
					</p> --%>
				</div>
				...
				<div class="col-md-12">
						...
						<a href="deleteGBTCB?id_gbt=${list.id_gbt}" style="cursor: pointer;"
