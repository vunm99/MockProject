				...
				<div class="modal-content ">
					...
					<div class="modal-body">
						<s:form method="post" commandName="tt" action="loginTT">
							...
							<c:if test="${ok=='ok' }"> đã gửi mật khẩu về email: ${tte.email}</c:if>
							<br>
							...
							<div class="row  mb-2 mt-3 text-center">
								<div class="col-12 col-sm-6 ">
									<a href="changepassTT" class="btn btn-primary btn-block">Đổi mật khẩu</a>
								</div>

								<div class="col-12 col-sm-6">
									<a href="resetPass" class="btn btn-primary btn-block">Quên mật khẩu</a>
								</div>
							</div>
						</s:form>
